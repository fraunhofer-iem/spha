...
class JsonKpiHierarchyTest {
    ...
    fun serializeHierarchyToExpectedJson() {
        ...
        val expected =
            "{\"root\":{\"typeId\":\"ROOT\",\"strategy\":\"MAXIMUM_STRATEGY\",\"edges\":[{\"target\":{\"typeId\":\"CODE_VULNERABILITY_SCORE\",\"strategy\":\"RAW_VALUE_STRATEGY\",\"edges\":[],\"thresholds\":[{\"name\":\"warning\",\"value\":50},{\"name\":\"critical\",\"value\":90}],\"reason\":\"CRA relevant\",\"tags\":[\"cvss\",\"cve\",\"cwe\"]},\"weight\":1.0}]},\"schemaVersion\":\"1.1.0\"}"
