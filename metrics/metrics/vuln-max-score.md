...
- **Not a replacement for full inventory metrics:** This metric tracks the _worst case_. Complementary metrics (e.g. count of critical vulnerabilities, mean time to remediate) are needed for a complete picture of vulnerability health.
